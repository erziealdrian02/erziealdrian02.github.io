...
const createAboutTemplate = (about) => `
    <div class="container">
        <div class="flex flex-wrap">
            <div class="w-full px-4 mt-11 lg:mb-10 lg:w-1/2">
                <h4
                class="font-bold uppercase text-primary dark:text-blue text-lg mb-2"
                >
                Tentang saya
                </h4>
                <h2
                class="font-bold text-dark text-3xl mb-3 max-w-md lg:text-4xl dark:text-white"
                >
                Senior Informatics Engineering Student
                </h2>
            </div>
            <div class="w-full px-4 mt-4 lg:mt-[80px] lg:w-1/2">
                <h3
                ...
                Mari coba berteman melalui beberapa Platform yang saya gunakan
                </p>
                ...
                <a
                    ...
                    target="_blank"
                    class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-secondary hover:border-primary hover:bg-primary hover:text-white"
                >
                    <svg
                    class="fill-current"
                    width="20"
                ...
                <a
                    ...
                    target="_blank"
                    class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-secondary hover:border-primary hover:bg-primary hover:dark:bg-blue hover:text-white"
                >
                    <svg
                    class="fill-current"
                    width="20"
