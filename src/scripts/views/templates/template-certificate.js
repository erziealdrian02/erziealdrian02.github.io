          ...
          <div class="w-full px-4 lg:w-1/2 xl:w-1/3 mb-3">
            <div class="bg-white rounded-xl shadow-lg overflow-hidden mb-10 dark:bg-slate-800 flex flex-col group relative h-[380px]">
              ...
              <div class="p-4 flex items-center">
                <img
                  src="${project.logo}"
                  alt="${project.logoDesc}"
                  class="w-10 h-10 rounded-full bg-white"
                />
                <p class="ml-3 font-bold text-1xl dark:text-slate-300">${
                  project.logoDesc
                }</p>
              </div>
      ...
      <div class="container">  
        <div class="w-full px-4">  
          <div class="w-full mx-auto text-center mb-16">  
            <h4 class="font-semibold text-lg text-primaryLight dark:text-blue mb-2">${getCurrentLanguageText(
              headerText.certification
            )}</h4>  
            <h2 class="font-bold text-black text-3xl mb-4 sm:text-4xl lg:text-5xl dark:text-white">${getCurrentLanguageText(
              headerText.label
            )}</h2>  
            <p class="font-medium text-md text-secondary md:text-lg dark:text-slate-200">${getCurrentLanguageText(
